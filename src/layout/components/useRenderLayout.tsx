...
export const useRenderLayout = () => {
  const renderClassic = () => {
    return (
      <>
        <div class={['absolute top-0 left-0 h-[100%]', { '!fixed z-3000': mobile.value }]}>
          {logo.value ? (
            <Logo
              class={[
                'bg-[var(--left-menu-bg-color)] border-b-1 border-solid border-[var(--logo-border-color)] dark:border-[var(--el-border-color)]',
                {
        ...
        >
          ...
          >
            <div
              ...
              style="transition: all var(--transition-time-02);"
            >
              <ToolHeader class="border-b-1 border-solid border-[var(--top-tool-border-color)] dark:border-[var(--el-border-color)]"></ToolHeader>

              {tagsView.value ? (
                <TagsView class="border-b-1 border-t-1 border-solid border-[var(--tags-view-border-color)] dark:border-[var(--el-border-color)]"></TagsView>
              ) : undefined}
            </div>
